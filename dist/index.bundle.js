...
const generateCard = (task) => {
  ...
  for (let buttonEtc of buttonsEtc) {
    ...
    if (buttonEtc.class === 'duedate') {
      ...
      const p = document.createElement('p');
      p.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate, 'd LLL');
...
const setDueDate = (e) => {
  ...
  document.querySelector('.button.duedate.clicked > p').textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(dueDate, 'd LLL');
...
const displayCurrentCardDate = (task) => {
  if (task) {
    dropdownDueDateInput.value = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate, 'yyyy-MM-dd');
  }
  else {
    dropdownDueDateInput.value = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(Date.now(), 'yyyy-MM-dd');
  }
}
...
const initializeFocusedCardData = (selectedCard) => {
  if (selectedCard.hasAttribute('data-index')) {
    ...
    document.querySelector('#buttonFocusedCardDueDate > p').textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate, 'd LLL');
    ...
    document.querySelector('#buttonFocusedCardDueDate > p').textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(Date.now(), 'd LLL');
